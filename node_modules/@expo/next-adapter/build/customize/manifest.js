...
function getDependencies(projectRoot) {
    const dependencies = ['react-native-web', 'next'].filter(dependency => !config_1.projectHasModule(dependency, projectRoot, {}));
    const devDependencies = ['@expo/next-adapter', 'babel-preset-expo'].filter(dependency => !config_1.projectHasModule(dependency, projectRoot, {}));
...
exports.manifest = [
    ...
    },
    {
        ...
        type: 'extra',
        destinationPath: projectRoot => path_1.default.resolve(projectRoot, './public/service-worker.js'),
        templatePath: path_1.default.resolve(packageRoot, 'template/service-worker.js'),
    ...
    },
    {
        name: 'server.js',
        type: 'extra',
        destinationPath: projectRoot => path_1.default.resolve(projectRoot, './server.js'),
        templatePath: path_1.default.resolve(packageRoot, 'template/server.js'),
    ...
    },
    {
        ...
        type: 'extra',
        destinationPath: projectRoot => path_1.default.resolve(projectRoot, './server.js'),
        templatePath: path_1.default.resolve(packageRoot, 'template/server-custom.js'),
